              ...
              {(variantOptionsByProduct[variantModal.productId] || []).map((opt) => {
                ...
                return (
                  <button
                    ...
                    title={duplicated ? "Đã có trong giỏ" : outOfStock ? "Bán hết" : ""}
